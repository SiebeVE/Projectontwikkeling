...
function initMap() {
	...
	function addmarker( latilongi, count ) {
		...
		var bubbleContent = '<div class="infoProject clearfix" contenteditable="false"><h3>' + projects[ count ][ 'name' ];
		if (ended) {
			bubbleContent += '<span class="afgesloten"> (Afgesloten)</span>';
		}
		bubbleContent += '</h3>' + '<div class="projectContent"><h5>Omschrijving: </h5><p>' + projects[ count ][ 'description' ] + '</p><h6>Adres: ' +
			projects[ count ][ 'address' ] + '</h6></div><div class="projectImageContainer"><div id="imagePlaceholder"><img class="projectImage" style="left:' + projects[ count ][ 'photo_left_offset' ] + '" src="' +
			projects[ count ][ 'photo_path' ] + '" alt="project foto"/></div><div class="projectlink">';
		if (ended) {
			bubbleContent += '<a class="pull-right" href="' + window.location.origin +
				'/project/statistieken/' + projects[ count ][ 'id' ] + '">Bekijk de statistieken!</a>';
		}
		else {
			bubbleContent += '<a class="pull-right" href="' + window.location.origin +
				'/project/beoordelen/' + projects[ count ][ 'id' ] + '">Bekijk het project!</a>';
		}
		bubbleContent += '</div></div></div>';
